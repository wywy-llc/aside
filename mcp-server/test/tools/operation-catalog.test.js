...
import { getOperationDefinition, getOperationsByCategory, getAllOperationIds, generateOperationCode, generateOperationsCodes, generateExportsList, } from '@/tools/operation-catalog';
describe('Operation Catalog', () => {
    ...
    describe('generateOperationsCodes', () => {
        ...
        it('should generate code for multiple operations', () => {
            const code = generateOperationsCodes(['create', 'getAll', 'update'], context);
            expect(code).toContain('const create');
            expect(code).toContain('const getAll');
            expect(code).toContain('const update');
        });
        ...
        it('should maintain order of operations', () => {
            const code = generateOperationsCodes(['delete', 'create', 'getAll'], context);
    ...
    describe('generateExportsList', () => {
        it('should generate exports list for operations', () => {
            const exports = generateExportsList(['create', 'getAll', 'update', 'delete']);
    ...
    describe('Operation Parameters Validation', () => {
        ...
        it('should have rowIndex parameter for update', () => {
            ...
            const hasRowIndex = operation?.parameters.some(p => p.name === 'rowIndex' || p.name.includes('index'));
